...
/* Constants for Buffer Sizes and Flags */
#define READ_BUF_SIZE 1024
#define WRITE_BUF_SIZE 1024
#define BUF_FLUSH -1

/* Constants for Command Chaining and Number Conversion */
#define CMD_NORM    0
#define CMD_OR      1
#define CMD_AND     2
#define CMD_CHAIN   3
...
/* Macro for Initializing the info_t Structure */
#define INFO_INIT \
